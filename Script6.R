...
ETR.List[["Affiliates"]][["ETRweighted"]]$sd <- sqrt(wtd.var(unique(Reduce("rbind", ETR.List[["Byanyown"]][["ETRunweightedTax"]])[,13]), sqrt(unique(Reduce("rbind", ETR.List[["Byanyown"]][["ETRunweightedTax"]])[,12])^2), na.rm = TRUE ))
...
ETR.List[["GerGUO"]][["ETRweighted"]]$sd <- sqrt(wtd.var(unique(Reduce("rbind", ETR.List[["ByanysubGER"]][["ETRunweightedTax"]])[,13]), sqrt(unique(Reduce("rbind", ETR.List[["ByanysubGER"]][["ETRunweightedTax"]])[,12])^2), na.rm = TRUE ))
